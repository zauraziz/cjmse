...
const dict = {
  az: {
    ...
    types: { research: 'Tədqiqat məqaləsi', review: 'İcmal məqaləsi', technical: 'Texniki məqalə', short: 'Qısa məlumat', editorial: 'Redaksiya məqaləsi' },
  ...
  en: {
    ...
    types: { research: 'Research Article', review: 'Review Article', technical: 'Technical Article', short: 'Short Communication', editorial: 'Editorial' },
  ...
  ru: {
    ...
    types: { research: 'Научная статья', review: 'Обзорная статья', technical: 'Техническая статья', short: 'Краткое сообщение', editorial: 'Редакционная статья' },
