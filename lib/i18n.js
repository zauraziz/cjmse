...
const dict = {
  az: {
    ...
    nav_articles: 'Məqalələr', nav_issues: 'Arxiv', nav_forAuthors: 'Müəlliflər üçün qaydalar',
    nav_contact: 'Əlaqə', nav_faq: 'FAQ',
    hero_title: 'Xəzər Dəniz Elmləri və Mühəndisliyi Jurnalı',
    hero_sub: 'Caspian Journal of Maritime Science & Engineering (CJMSE)',
    hero_desc: 'Dənizçilik və mühəndislik sahələrində orijinal tədqiqat, icmal və texniki məqalələr dərc edən beynəlxalq açıq giriş elmi jurnalı. İkili kor resenziya, tam rəqəmsal redaksiya prosesi və beynəlxalq indeksləşmə prinsiplərinə əsaslanır. Bütün məqalələr açıq giriş siyasəti çərçivəsində ödənişsiz təqdim olunur.',
    hero_browse: 'Məqalələrə bax',
    sub_title: 'Yeni məqalələrdən xəbərdar olun',
    sub_desc: 'Hər yeni açıq giriş məqaləsi dərc olunan kimi birbaşa e-poçtunuza bildiriş alın. Dənizçilik və mühəndislik tədqiqatçıları icmasına qoşulun.',
    sub_ph: 'E-poçt ünvanınız',
    sub_btn: 'Abunə ol',
    sub_ok: 'Təşəkkürlər! Təsdiq məktubu e-poçtunuza göndərildi.',
    sub_err: 'Xəta baş verdi. E-poçt ünvanını yoxlayın.',
    sub_privacy: 'Spam yoxdur — istənilən vaxt abunəlikdən çıxa bilərsiniz.',
    foot_subHeading: 'Yeni məqalələrə abunə olun',
    foot_developedBy: 'Hazırladı',
    foot_rights: 'Bütün hüquqlar qorunur.',
    submit: 'Məqalə göndər', searchPh: 'Axtarış…', menu: 'Menyu',
  ...
  en: {
    ...
    nav_articles: 'Articles', nav_issues: 'Archive', nav_forAuthors: 'Author Guidelines',
    nav_contact: 'Contact', nav_faq: 'FAQ',
    hero_title: 'Open Access Journal of Maritime and Engineering Sciences',
    hero_sub: 'Caspian Journal of Maritime Science & Engineering (CJMSE)',
    hero_desc: 'An international open access scientific journal publishing original research, review and technical articles in the maritime and engineering fields. Built on double-blind peer review, a fully digital editorial process and international indexing. All articles are submitted free of charge under an open access policy.',
    hero_browse: 'Browse Articles',
    sub_title: 'Stay updated on new research',
    sub_desc: 'Get notified by email the moment each new open-access article is published. Join a community of maritime and engineering researchers.',
    sub_ph: 'Your email address',
    sub_btn: 'Subscribe',
    sub_ok: 'Thank you! A confirmation has been sent to your inbox.',
    sub_err: 'Something went wrong. Please check your email address.',
    sub_privacy: 'No spam — unsubscribe anytime.',
    foot_subHeading: 'Subscribe to new articles',
    foot_developedBy: 'Developed by',
    foot_rights: 'All rights reserved.',
    submit: 'Submit Article', searchPh: 'Search…', menu: 'Menu',
  ...
  ru: {
    ...
    nav_articles: 'Статьи', nav_issues: 'Архив', nav_forAuthors: 'Руководство для авторов',
    nav_contact: 'Контакты', nav_faq: 'FAQ',
    hero_title: 'Журнал открытого доступа по морским и инженерным наукам',
    hero_sub: 'Caspian Journal of Maritime Science & Engineering (CJMSE)',
    hero_desc: 'Международный научный журнал открытого доступа, публикующий оригинальные исследовательские, обзорные и технические статьи в области морских и инженерных наук. Основан на двойном слепом рецензировании, полностью цифровом редакционном процессе и международной индексации. Все статьи подаются бесплатно в рамках политики открытого доступа.',
    hero_browse: 'Просмотр статей',
    sub_title: 'Будьте в курсе новых статей',
    sub_desc: 'Получайте уведомление на почту, как только выходит новая статья открытого доступа. Присоединяйтесь к сообществу исследователей морских и инженерных наук.',
    sub_ph: 'Ваш эл. адрес',
    sub_btn: 'Подписаться',
    sub_ok: 'Спасибо! Письмо с подтверждением отправлено на вашу почту.',
    sub_err: 'Произошла ошибка. Проверьте адрес эл. почты.',
    sub_privacy: 'Без спама — отписка в любой момент.',
    foot_subHeading: 'Подписка на новые статьи',
    foot_developedBy: 'Разработчик',
    foot_rights: 'Все права защищены.',
    submit: 'Подать статью', searchPh: 'Поиск…', menu: 'Меню',
